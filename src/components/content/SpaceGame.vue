...
export default {
  ...
  setup () {
    ...
    const { stageCanvas } = useThreeStage(mode.isAlienMode, { enemies, projectiles, consumeProjectile, maybeDropFromAsteroid, ally, powerUps, getShipRenderState, enemyHealthRatio, healthColor })
